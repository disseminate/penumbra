...
BUY_ITEMS = {
	...
	{ "Flashlight Upgrade #1", "Get 150% of the regular flashlight power.", 150, "", "models/props_lab/tpplug.mdl", function( ply ) ply:SetNWInt( "MaxFlashlight", 150 ) end, function( ply ) return ( ply:GetNWInt( "MaxFlashlight" ) == 150 ) end },
	...
	{ "Flashlight Upgrade #2", "Get 300% of the regular flashlight power.", 350, "", "models/props_lab/tpplug.mdl", function( ply ) ply:SetNWInt( "MaxFlashlight", 300 ) end, function( ply ) return ( ply:GetNWInt( "MaxFlashlight" ) == 300 ) end }
}
