...
BUY_ITEMS = {
	...
	{ "Flashlight Upgrade #1", "Get 150% of the regular flashlight power.", 150, "", "models/props_lab/tpplug.mdl", function( ply ) ply:SetNWInt( "MaxFlashlight", 150 ) ply:SetNWInt( "flashlightpwr", 150 ) end, function( ply ) return ( ply:GetNWInt( "MaxFlashlight" ) == 150 ) end },
